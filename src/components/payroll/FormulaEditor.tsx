...
const LINE_META: Record<string, { label: string; description: string }> = {
  ...
  paidLeave: { label: 'Paid Leave', description: 'Allowed paid leave days used' },
  lopLeave: { label: 'LOP Leave', description: 'Loss of pay days (excess leave)' },
  lopDays: { label: 'LOP Days', description: 'Total loss of pay days' },
...
const VARIABLES = [
  ...
  { value: 'paidLeave', label: 'Paid Leave', desc: 'Allowed paid leave days used' },
  { value: 'lopLeave', label: 'LOP Leave', desc: 'Loss of pay days (excess leave)' },
  { value: 'lopDays', label: 'LOP Days', desc: 'Total loss of pay days' },
...
const DEFAULT_EXPRESSIONS: Record<string, string> = {
  ...
  lopLeave: 'MAX(0, approvedLeave + unapprovedLeave - allowedPaidLeaves)',
  lopDays: 'approvedLeave + unapprovedLeave',
  holidays: 'holidays',
  approvedLeave: 'approvedLeave',
  unapprovedLeave: 'totalDaysInMonth - present - wfh - approvedLeave - holidays',
  // Calculated components
  paidDays: 'present + wfh + (halfDay * 0.5) + paidLeave - lopLeave',
  proratedGross: 'grossSalary * (paidDays / totalDaysInMonth)',
  basic: '(grossSalary * paidDays / 26) * (basicPercentage / 100)',
  hra: '(grossSalary * paidDays / 26) * (hraPercentage / 100)',
  special: '(grossSalary * paidDays / 26) * (specialPercentage / 100)',
  totalDeductions: '0',
